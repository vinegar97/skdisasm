...
ArtUnc_Knuckles2P:
		...
		even
Map_Sonic:
		include "General/Sprites/Sonic/Map - Sonic S3.asm"
PLC_Sonic:
		include "General/Sprites/Sonic/DPLC - Sonic S3.asm"
Map_Tails:
		include "General/Sprites/Tails/Map - Tails S3.asm"
PLC_Tails:
		include "General/Sprites/Tails/DPLC - Tails S3.asm"
Map_Tails_Tail:
